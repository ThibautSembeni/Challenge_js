    ...
    <div class="sm:ml-64">
        ...
        <div class="p-4 lg:p-10">
            ...
            <div class="flex items-center">
                <h1 class="text-3xl font-bold mr-3"><i class="fa-solid fa-boxes-stacked mr-2"></i> Produits</h1>

                <router-link :to="{ name: 'productAdd' }" class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Ajouter un produit</router-link>
            </div>
