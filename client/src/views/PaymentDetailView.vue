        ...
        <div class="p-4 lg:p-10">
            ...
            <div class="flex flex-wrap justify-between border-b border-gray-200 pb-5">
                <p class="font-bold text-2xl flex flex-wrap items-center">
                    ...
                    <span class="bg-green-100 text-green-800 text-sm font-medium ml-2 px-2.5 py-0.5 rounded">Réussi</span>
                </p>
                ...
                <table class="font-light text-left">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="p-3 border-r"><i class="fa-brands fa-cc-visa mr-2"></i> <i class="fa-solid fa-ellipsis mr-2"></i> 4448</td>
            ...
            <PaymentDetail title="Chronologie">
                <ol class="relative border-l border-gray-200 mt-4">
                    <li class="mb-7 ml-6">
                        ...
                        <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Le 27 avril. 08:45</time>
                    </li>
                    <li class="ml-6">
                        ...
                        <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Le 27 avril. 08:42</time>
                    </li>
                </ol>
            </PaymentDetail>
                ...
                <div class="flex flex-wrap justify-between my-4">
                    <div class="w-full md:w-1/2">
                        <div class="flex flex-wrap">
                            ...
                            <PaymentDetailLine title="Adresse" content="2T route de villechavant, Villebougis, 89150 France" />
                        </div>
                    </div>
                </div>
            </PaymentDetail>
