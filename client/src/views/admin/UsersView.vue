  ...
  <div class="sm:ml-64">
    ...
    <div class="p-4 lg:p-10">
      <div class="flex items-center">
        <h1 class="text-3xl font-bold mr-3"><i class="fa-solid fa-user mr-2"></i> Utilisateurs</h1>
        ...
        <router-link
          ...
          >Voir les demandes marchants</router-link
        >
      </div>
                  ...
                  :actions="[
                    {
                      label: 'Voir',
                      onClick: () =>
                        router.push({ name: 'adminUserDetails', params: { userId: user.id } })
                    },
                    {
