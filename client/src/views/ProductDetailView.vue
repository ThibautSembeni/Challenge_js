...
async function getProduct () {
    const response = await fetch(`${import.meta.env.VITE_API_URL}/products/${useRoute().params.reference}`, {
        method: 'GET',
        headers: {
    ...
    if (response.ok) {
        const product_item = await response.json()
        Object.assign(product, product_item)
