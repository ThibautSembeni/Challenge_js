...
export async function getTransactions() {
  ...
  if (response.status === 200) {
    ...
    throw new Error(
      `Error: ${response.status} - Une erreur s'est produite lors de la récupération des transactions`
    )
  }
}
...
export async function getTransaction(id) {
  ...
  if (response.status === 200) {
    ...
    throw new Error(
      `Error: ${response.status} - Une erreur s'est produite lors de la récupération de la transaction`
    )
  }
}
...
export async function updateTransaction(transaction) {
  ...
  if (response.status === 200) {
    ...
    throw new Error(
      `Error: ${response.status} - Une erreur s'est produite lors de la mise à jour de la transaction`
    )
  }
}
...
export async function deleteTransaction(id) {
  ...
  if (response.status === 204) {
    ...
    throw new Error(
      `Error: ${response.status} - Une erreur s'est produite lors de la suppression de la transaction`
    )
  }
}
...
export async function getTransactionHistory(reference) {
  ...
  if (response.status === 200) {
    ...
    throw new Error(
      `Error: ${response.status} - Une erreur s'est produite lors de la récupération de l'historique de la transaction`
    )
  }
}
