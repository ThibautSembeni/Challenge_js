...
module.exports = new genericRouter(
  new genericController(new TransactionService(), {
    ...
    customRoutes: [
      {
        ...
        handler: "getTransactionsByUserId",
      },
      {
        method: "get",
        path: "/transaction/subscribe",
        middleware: [checkSSE],
        handler: "subscribe",
      },
      { method: "post", path: "/", middleware: [], handler: "transaction" },
      {
        ...
        middleware: [checkSSE],
        handler: "subscribeToTransactionsStats",
      },
      {
        method: "get",
        path: "/stats/amountbyday",
        middleware: [checkAuth],
        handler: "getTransactionsVolumeByDays",
      },
      {
        method: "get",
        path: "/stats/numberbyday",
        middleware: [checkAuth],
        handler: "getTransactionsNumberByDays",
      },
      {
        method: "get",
        path: "/stats/numberbyyear",
        middleware: [checkAuth],
        handler: "getTransactionsNumberByYear",
      },
